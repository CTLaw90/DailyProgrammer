...
'''
I've made this overly complicated....attempting a new solution using numpy....
'''
...
class cube:
	def __init__(self):
		...
		self.f.setAdjacent(self.l.rightEdge,self.r.leftEdge,self.upEdge,self.downEdge)
	...
	def turn90(self, mainSide):
		...
		"""
		x = mainSide.face
		a,b,c,d = mainSide.left,mainSide.up,mainSide.right,mainSide.down
